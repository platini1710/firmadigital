...
public class GeneradorFilePdf {
	...
	public String generaFileReclamposPdf(String ordinario,String nombreSolicitante, String nombreTipificacion, String problemaSalud,
			long idCaso, String respuesta, String clave, int ord, String tipo, String de,String wsdl,String run,int genero, String parrafoUno,String parrafoDos)
	...
	public String generaFileSolicitudPdf(String ordinario,String nombreSolicitante, String nombreTipificacion, String problemaSalud,
			long idCaso, String respuesta, String clave, int ord, String tipo, String de,String wsdl,String run,int genero,String parrafoUno,String parrafoDos)
			throws IOException, DocumentException {
 ...
 float  h=46f;
		log.info("respuesta :: " + respuesta + ".pdf");
			...
			tableHeadRight.addCell(HeadCellRight1);
			document.add(tableHeadRight);
			System.out.println("errorv  1 ");
			Chunk chunkDE = new Chunk("DE : " + de.trim() + "\r\n        JEFA (S) DEPARTAMENTO GESTIÓN CIUDADANA\r\n        FONDO NACIONAL DE SALUD\r\n",
					paragraNegrita);
			...
			//******************************Body Reclamo                ******************************************************
		Chunk chunk = new Chunk(parrafoUno+ "\r\n",paragraFontNormal);
			

			paragraphBody.setAlignment(Paragraph.ALIGN_JUSTIFIED);
			paragraphBody.add(chunk);
			
			 chunk = new Chunk(respuesta + "\r\n", f2);
			paragraphBody.add(chunk);	

			chunk = new Chunk(parrafoDos+ "\r\n",
					paragraFontNormal);
			paragraphBody.add(chunk);
			PdfPTable tableBody= new PdfPTable(1);
			tableBody.setWidthPercentage(100);
			...
			cellBody.setHorizontalAlignment(Element.ALIGN_CENTER);
			cellBody.setBorder(Rectangle.NO_BORDER );
			cellBody.setFixedHeight(174f);
			cellBody.addElement(paragraphBody);
			tableBody.addCell(cellBody);

	
			document.add(tableBody);
			log.info("parrafoDos ::" + parrafoDos);
	...
	public String generaFileDenunciaPdf(String ordinario,String nombreSolicitante, String nombreTipificacion, String problemaSalud,
			long idCaso, String respuesta, String clave, int ord, String tipo, String de,String wsdl,String run,int genero,String parrafoUno,String parrafoDos)
			throws IOException, DocumentException {
		...
		log.info("parrafoUno :: " + parrafoUno );
			...
			HeadCellRight1.setBorder(Rectangle.NO_BORDER);
			HeadCellRight1.addElement(paragraphead);
			HeadCellRight1.setFixedHeight(46f);
			tableHeadRight.addCell(HeadCellRight1);
			document.add(tableHeadRight);
